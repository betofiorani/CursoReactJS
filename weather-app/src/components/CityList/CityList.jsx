...
const renderCityAndCountry = eventOnClickCity => (cityAndCountry, weather) => {
    ...
    return <CityListItem 
                ...
                {...cityAndCountry} //podemos pasarlos directamente con destructuring
                weather = {weather} 
...
export default React.memo(CityList); // podemos encapsular con react.memo la exportacion y no el componente
